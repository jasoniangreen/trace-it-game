        ...
        {shareUrl ? (
          <>
            <div className="win-modal__actions">
              <button className="win-modal__btn win-modal__btn--share" onClick={handleShareResult}>
                {copied ? 'Copied!' : 'Share Result'}
              </button>
              <button className="win-modal__btn win-modal__btn--share" onClick={handleShareLevel}>
                Share Level
              </button>
            </div>
            <div className="win-modal__actions">
